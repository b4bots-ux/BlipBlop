      ...
      <section className="relative">
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-6 sm:px-6 lg:px-8">
          ...
          <div className="rounded-[2rem] border border-white/50 bg-white/30 p-5 shadow-[0_10px_40px_rgba(21,35,71,0.08)] backdrop-blur-md sm:p-8 md:p-10">
            ...
            <div className="mt-10 rounded-[2rem] border border-white/40 bg-white/38 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)] backdrop-blur-md sm:p-7">
              ...
              <div className="mt-4 flex items-start justify-between gap-4">
                <div className="min-w-0">
                  <div className="text-[clamp(2.25rem,9vw,5rem)] font-semibold leading-none tracking-tight text-[#111827]">
                    68.7/100
                  </div>
            ...
            <div className="mt-10 rounded-[2.25rem] bg-gradient-to-b from-[#d8e0f2]/95 to-[#8e9dc2]/95 p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.28)] sm:p-5">
              <div className="rounded-[2rem] border border-white/40 bg-white/34 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.55)] backdrop-blur-md sm:p-8">
                <div className="mb-6 flex items-center justify-between gap-3">
                  <div className="text-xs uppercase tracking-[0.24em] text-neutral-500 sm:text-lg">
                    Live estimate
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-6">
                  {stats.map((stat) => (
                    <div
                      key={stat.label}
                      className="min-w-0 rounded-[1.5rem] border border-white/35 bg-white/58 p-4 shadow-[0_6px_18px_rgba(25,40,77,0.06)] backdrop-blur-sm sm:rounded-[1.75rem] sm:p-6"
                    >
                      <div className="text-sm text-neutral-500 sm:text-lg">
                        {stat.label}
                      </div>

                      <div className="mt-3 min-w-0 overflow-hidden text-[clamp(1.08rem,4.1vw,3.1rem)] font-semibold leading-[0.95] tracking-tight text-[#111827] sm:text-[clamp(1.6rem,4vw,3.1rem)]">
                        <LiveTickerNumber
                          base={stat.base}
                      ...
                      <div className="mt-3 text-xs leading-5 text-neutral-500 sm:mt-4 sm:max-w-[14ch] sm:text-[1.7rem] sm:leading-10">
                        {stat.description}
                      </div>
                    </div>
                  ))}
